...
#
# Usage:
#   scripts/check_upstream_drift.sh                # human-readable summary
#   scripts/check_upstream_drift.sh --json         # JSON only
#   scripts/check_upstream_drift.sh --fail-on-drift  # exit 1 if any drift
#
# Exit codes:
