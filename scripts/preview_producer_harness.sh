...
usage() {
  cat <<'EOF'
Usage:
  scripts/preview_producer_harness.sh generate
  scripts/preview_producer_harness.sh wallet
  scripts/preview_producer_harness.sh certs
  scripts/preview_producer_harness.sh funding-address
  scripts/preview_producer_harness.sh validate
  scripts/preview_producer_harness.sh smoke-relay
  scripts/preview_producer_harness.sh smoke-producer
  scripts/preview_producer_harness.sh endurance-relay
  scripts/preview_producer_harness.sh endurance-producer
  scripts/preview_producer_harness.sh all
...
RUN_SECONDS=60 scripts/preview_producer_harness.sh smoke-producer
\`\`\`
