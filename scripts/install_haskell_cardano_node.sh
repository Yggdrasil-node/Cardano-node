...
#
# Usage:
#   scripts/install_haskell_cardano_node.sh           # install latest
#   CARDANO_NODE_VERSION=10.7.1 scripts/install_haskell_cardano_node.sh
#   scripts/install_haskell_cardano_node.sh --force
#
# Exit codes:
