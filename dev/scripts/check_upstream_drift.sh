...
#
# Usage:
#   dev/scripts/check_upstream_drift.sh                # human-readable summary
#   dev/scripts/check_upstream_drift.sh --json         # JSON only
#   dev/scripts/check_upstream_drift.sh --fail-on-drift  # exit 1 if any drift
#
# Exit codes:
