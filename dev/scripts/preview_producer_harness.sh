...
# configuration/ is a workspace-root sibling of scripts/ to mirror the
# upstream Haskell repository layout; reach it script-locally.
ROOT_DIR="$(cd "$SCRIPT_DIR/.." && pwd)"
PREVIEW_REF_DIR="$ROOT_DIR/configuration/preview"
...
usage() {
  cat <<'EOF'
Usage:
  dev/scripts/preview_producer_harness.sh generate
  dev/scripts/preview_producer_harness.sh wallet
  dev/scripts/preview_producer_harness.sh certs
  dev/scripts/preview_producer_harness.sh funding-address
  dev/scripts/preview_producer_harness.sh validate
  dev/scripts/preview_producer_harness.sh smoke-relay
  dev/scripts/preview_producer_harness.sh smoke-producer
  dev/scripts/preview_producer_harness.sh endurance-relay
  dev/scripts/preview_producer_harness.sh endurance-producer
  dev/scripts/preview_producer_harness.sh all
...
RUN_SECONDS=60 dev/scripts/preview_producer_harness.sh smoke-producer
\`\`\`
