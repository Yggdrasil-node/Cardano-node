...
#
# Usage:
#   dev/reference/install_haskell_cardano_node.sh           # install latest
#   CARDANO_NODE_VERSION=10.7.1 dev/reference/install_haskell_cardano_node.sh
#   dev/reference/install_haskell_cardano_node.sh --force
#
# Exit codes:
