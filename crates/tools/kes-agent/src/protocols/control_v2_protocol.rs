...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Control/V2/Protocol.hs.
//!
//! Direct data-level mirror of upstream
//! `Cardano.KESAgent.Protocols.Control.V2.Protocol`. Concrete KES
...
/// Agent state information returned by Control V2 `InfoMessage`.
...
/// Messages in Control V2. Mirrors upstream
...
pub const CP_VERSION_IDENTIFIER_TEXT: &str = "Control:2.0";

/// Version identifier for upstream Control V2 `ControlProtocol`.
...
mod tests {
    ...
    #[test]
    fn control_v2_version_identifier_matches_upstream_text() {
        assert_eq!(CP_VERSION_IDENTIFIER_TEXT, "Control:2.0");
        assert_eq!(cp_version_identifier().as_str(), "Control:2.0");
    }
    ...
    #[test]
    fn agent_info_record_preserves_control_v2_required_fields() {
        let info = AgentInfo {
