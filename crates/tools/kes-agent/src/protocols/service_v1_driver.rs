...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Service/V1/Driver.hs.
//!
//! Mirrors the pure read-error mapping and key-message surface of
//! upstream `Service.V1.Driver`. Raw bearer send/receive and direct
    ...
    fn read_error_to_service_driver_trace_matches_upstream_mapping() {
        ...
        assert_eq!(
            read_error_to_service_driver_trace(ReadResult::ReadVersionMismatch {
                expected: mk_version_identifier("Service:1.0"),
                actual: mk_version_identifier("Service:2.0"),
            }),
