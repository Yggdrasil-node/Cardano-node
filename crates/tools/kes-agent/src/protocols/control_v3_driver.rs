...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Control/V3/Driver.hs.
//!
//! Mirrors the pure discriminator and read-error mapping surface of
//! upstream `Control.V3.Driver`. Raw bearer send/receive and direct
//! serialization remain deferred to the daemon/socket follow-on.

use super::control_v3_protocol::ControlMessage;
...
/// idle-state Control V3 command messages.
...
/// Control V3 command discriminator.
    ...
    fn read_error_to_control_driver_trace_matches_upstream_mapping() {
        ...
        assert_eq!(
            read_error_to_control_driver_trace(ReadResult::ReadVersionMismatch {
                expected: mk_version_identifier("Control:3.0"),
