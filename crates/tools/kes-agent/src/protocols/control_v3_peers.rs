...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Control/V3/Peers.hs.
//!
...
use super::control_v3_protocol::{AgentInfo, ControlMessage, OCert, VerKeyKES};
...
/// Initial message sent by every upstream Control V3 server peer.
...
mod tests {
    use super::*;
    use crate::protocols::control_v3_protocol::ConnectionStatus;
    ...
    fn sample_agent_info() -> AgentInfo {
        AgentInfo {
            ...
            agent_info_bootstrap_connections: vec![
                crate::protocols::control_v3_protocol::BootstrapInfo {
