...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Control/V1/Peers.hs.
//!
...
use super::control_v1_protocol::{AgentInfo, ControlMessage, OCert, VerKeyKES};
...
/// Initial message sent by every upstream Control V1 server peer.
...
/// Command message emitted by upstream Control V1 `controlDropKey`.
///
/// Control V1 predates installed-key dropping, so upstream
...
/// Extract the result handled by upstream Control V1 `controlDropKey`.
...
mod tests {
    use super::*;
    use crate::protocols::control_v1_protocol::ConnectionStatus;
    ...
    fn sample_agent_info() -> AgentInfo {
        AgentInfo {
            ...
            agent_info_bootstrap_connections: vec![
                crate::protocols::control_v1_protocol::BootstrapInfo {
