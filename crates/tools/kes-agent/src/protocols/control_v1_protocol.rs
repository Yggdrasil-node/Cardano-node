...
//! ## Naming parity
//!
//! **Strict mirror:** deps/kes-agent/kes-agent/src/Cardano/KESAgent/Protocols/Control/V1/Protocol.hs.
//!
//! Direct data-level mirror of upstream
//! `Cardano.KESAgent.Protocols.Control.V1.Protocol`. Concrete KES
...
/// Agent state information returned by Control V1 `InfoMessage`.
...
/// Messages in Control V1. Mirrors upstream
...
pub const CP_VERSION_IDENTIFIER_TEXT: &str = "Control:1.0";

/// Version identifier for upstream Control V1 `ControlProtocol`.
...
mod tests {
    ...
    #[test]
    fn control_v1_version_identifier_matches_upstream_text() {
        assert_eq!(CP_VERSION_IDENTIFIER_TEXT, "Control:1.0");
        assert_eq!(cp_version_identifier().as_str(), "Control:1.0");
    }
    ...
    #[test]
    fn agent_info_record_preserves_control_v1_required_fields() {
        let info = AgentInfo {
        ...
        let bundle = info
            ...
            .as_ref()
            .expect("Control V1 current bundle fixture should exist");
