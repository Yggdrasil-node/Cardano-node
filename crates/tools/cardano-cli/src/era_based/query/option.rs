...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Query/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Query.Option` types; the Rust port lands
