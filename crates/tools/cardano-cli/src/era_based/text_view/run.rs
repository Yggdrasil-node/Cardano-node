...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/TextView/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.TextView.Run` types; the Rust port lands
