...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Transaction/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Transaction.Command` types; the Rust port lands
