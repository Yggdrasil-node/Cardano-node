...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Actions/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Actions.Run` types; the Rust port lands
