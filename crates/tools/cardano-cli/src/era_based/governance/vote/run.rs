...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Vote/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Vote.Run` types; the Rust port lands
