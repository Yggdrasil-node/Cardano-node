...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/DRep/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.DRep.Option` types; the Rust port lands
