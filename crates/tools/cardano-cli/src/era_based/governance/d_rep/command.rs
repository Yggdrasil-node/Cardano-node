...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/DRep/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.DRep.Command` types; the Rust port lands
