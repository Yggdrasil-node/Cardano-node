...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Committee/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Committee.Command` types; the Rust port lands
