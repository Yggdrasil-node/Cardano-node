...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Committee/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Committee.Option` types; the Rust port lands
