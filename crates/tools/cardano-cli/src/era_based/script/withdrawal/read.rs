...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Script/Withdrawal/Read.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Script.Withdrawal.Read` types; the Rust port lands
