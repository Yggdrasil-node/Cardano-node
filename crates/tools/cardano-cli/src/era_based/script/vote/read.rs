...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Script/Vote/Read.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Script.Vote.Read` types; the Rust port lands
