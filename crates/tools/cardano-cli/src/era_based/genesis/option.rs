...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Genesis/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Genesis.Option` types; the Rust port lands
