...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/Run.hs`.
...
/// Compatible-cluster top-level Compatible runner / dispatcher placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.Run` types; the
