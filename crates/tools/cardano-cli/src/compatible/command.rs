...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/Command.hs`.
...
/// Compatible-cluster top-level Compatible command sum type placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.Command` types; the
