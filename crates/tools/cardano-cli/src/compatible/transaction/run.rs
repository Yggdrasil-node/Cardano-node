...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/Transaction/Run.hs`.
...
/// Compatible-cluster transaction runner placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.Transaction.Run` types; the
