...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/Governance/Command.hs`.
...
/// Compatible-cluster governance command sum type (vote / proposal / drep / committee) placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.Governance.Command` types; the
