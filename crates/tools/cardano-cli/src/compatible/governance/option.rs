...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/Governance/Option.hs`.
...
/// Compatible-cluster governance option parsers placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.Governance.Option` types; the
