...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Vote.hs`.
...
/// Byron-era byron update-proposal vote construction + submission placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Vote` types; the Rust
