...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Genesis.hs`.
...
/// Byron-era byron genesis-config creation (`create-testnet-genesis`) placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Genesis` types; the Rust
