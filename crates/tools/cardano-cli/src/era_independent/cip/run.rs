...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Cip/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Cip.Run` types; the Rust port lands
