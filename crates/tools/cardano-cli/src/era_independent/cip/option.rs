...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Cip/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Cip.Option` types; the Rust port lands
