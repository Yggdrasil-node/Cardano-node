...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Node/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Node.Run` types; the Rust port lands
