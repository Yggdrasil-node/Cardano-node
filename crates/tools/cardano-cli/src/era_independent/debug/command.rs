...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.Command` types; the Rust port lands
