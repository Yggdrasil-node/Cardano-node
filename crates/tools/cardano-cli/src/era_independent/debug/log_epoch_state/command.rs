...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/LogEpochState/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.LogEpochState.Command` types; the Rust port lands
