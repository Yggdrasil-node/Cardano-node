...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Address/Info/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Address.Info.Run` types; the Rust port lands
