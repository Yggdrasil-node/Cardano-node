...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Ping/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Ping.Option` types; the Rust port lands
