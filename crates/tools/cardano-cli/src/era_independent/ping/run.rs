...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Ping/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Ping.Run` types; the Rust port lands
