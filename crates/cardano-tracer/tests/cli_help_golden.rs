//! Golden test: yggdrasil-cardano-tracer `--help` / `--version` outputs are
//! byte-equivalent to the upstream `cardano-tracer` binary.
...
fn cargo_bin() -> std::path::PathBuf {
    std::path::PathBuf::from(env!("CARGO_BIN_EXE_cardano-tracer"))
}
