...
usage() {
  cat <<'EOF'
Usage:
  POOL_ID=pool1... crates/node/yggdrasil-node/scripts/preview_pool_activation_status.sh
...
if cred_dir:
    ...
    print("  crates/node/yggdrasil-node/scripts/run_preview_real_pool_producer.sh")
