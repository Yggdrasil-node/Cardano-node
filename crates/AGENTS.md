...
| Crate          | LOC     | Upstream package | Status                                       |
|----------------|---------|------------------|----------------------------------------------|
| `cardano-cli`  | ~3.9k   | `cardano-cli`    | `implemented_needs_11_0_1_evidence` — C-arc complete at R515; 33 `Command` variants wired in the standalone `yggdrasil-cardano-cli`; byte-equivalence evidence against upstream remains the operator-side gate. |
