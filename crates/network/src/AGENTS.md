...
- Typed ChainSync, BlockFetch, KeepAlive, and TxSubmission client drivers are in place.
- Next: typed protocol payload decoding (replace opaque `Vec<u8>` payloads where practical).
