...
//! ## Naming parity
//!
//! **Strict mirror:** Network/Mux.hs.
//! After R317 merged the previously-separate `multiplexer.rs`
//! types module into this file, `mux.rs` is a 1:1 mirror of
//! upstream `Ouroboros.Network.Mux` (SDU framing + per-channel
//! state machine + multiplexer/demultiplexer runtime), matching
//! upstream's single-file structure.
