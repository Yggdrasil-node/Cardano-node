...
- Next: typed protocol payloads (replace opaque `Vec<u8>` with ledger/domain types), peer lifecycle management (reconnection, peer registry), and higher-level sync orchestration across peers.
