...
- Ledger query surfaces now include `LedgerStateSnapshot`, `LedgerStateCheckpoint`, merged address/balance UTxO queries, and read-only access to explicit `PoolState` and `RewardAccounts` containers.
