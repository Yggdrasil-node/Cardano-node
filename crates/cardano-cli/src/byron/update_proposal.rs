...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/UpdateProposal.hs`.
...
/// Byron-era byron protocol-parameter update proposal creation + voting placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.UpdateProposal` types; the Rust
...
pub enum UpdateProposalPlaceholder {}
