...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Key.hs`.
...
/// Byron-era byron-era key generation, conversion, and signing placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Key` types; the Rust
