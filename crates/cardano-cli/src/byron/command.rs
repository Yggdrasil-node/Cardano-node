...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Command.hs`.
...
/// Byron-era byron-era command sum type (genesis / key / delegate / submit-tx / vote / update-proposal subcommands) placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Command` types; the Rust
