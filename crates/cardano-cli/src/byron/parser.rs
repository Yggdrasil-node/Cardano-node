...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Parser.hs`.
...
/// Byron-era byron-era clap parser shell placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Parser` types; the Rust
