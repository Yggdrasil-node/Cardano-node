...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Byron/Run.hs`.
...
/// Byron-era byron-era command runner / dispatcher placeholder.
///
/// Mirrors upstream `Cardano.CLI.Byron.Run` types; the Rust
