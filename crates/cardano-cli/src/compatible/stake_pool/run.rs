...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/Compatible/StakePool/Run.hs`.
...
/// Compatible-cluster stake-pool runner placeholder.
///
/// Mirrors upstream `Cardano.CLI.Compatible.StakePool.Run` types; the
