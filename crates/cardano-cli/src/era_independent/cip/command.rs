...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Cip/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Cip.Command` types; the Rust port lands
