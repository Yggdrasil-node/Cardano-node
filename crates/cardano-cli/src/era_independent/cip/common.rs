...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Cip/Common.hs`.
...
/// EraIndependent common placeholder.
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Cip.Common` types; the Rust port lands
