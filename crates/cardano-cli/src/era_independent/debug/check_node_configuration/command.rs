...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/CheckNodeConfiguration/Command.hs`.
...
/// EraIndependent command placeholder.
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.CheckNodeConfiguration.Command` types; the Rust port lands
