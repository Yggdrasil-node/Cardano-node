...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.Option` types; the Rust port lands
