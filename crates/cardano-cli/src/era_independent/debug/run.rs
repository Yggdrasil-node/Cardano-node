...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.Run` types; the Rust port lands
