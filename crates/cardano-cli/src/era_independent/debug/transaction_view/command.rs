...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/TransactionView/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.TransactionView.Command` types; the Rust port lands
