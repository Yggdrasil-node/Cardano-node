...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraIndependent/Debug/TransactionView/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraIndependent.Debug.TransactionView.Run` types; the Rust port lands
