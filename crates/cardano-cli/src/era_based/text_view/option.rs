...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/TextView/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.TextView.Option` types; the Rust port lands
