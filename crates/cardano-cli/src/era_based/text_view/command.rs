...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/TextView/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.TextView.Command` types; the Rust port lands
