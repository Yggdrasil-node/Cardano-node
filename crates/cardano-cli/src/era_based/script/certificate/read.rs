...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Script/Certificate/Read.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Script.Certificate.Read` types; the Rust port lands
