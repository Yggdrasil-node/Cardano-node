...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Script/Proposal/Read.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Script.Proposal.Read` types; the Rust port lands
