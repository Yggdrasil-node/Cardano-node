...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Script/Mint/Read.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Script.Mint.Read` types; the Rust port lands
