...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Query/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Query.Command` types; the Rust port lands
