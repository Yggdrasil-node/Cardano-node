...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Genesis/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Genesis.Run` types; the Rust port lands
