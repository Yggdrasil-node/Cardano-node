...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Transaction/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Transaction.Option` types; the Rust port lands
