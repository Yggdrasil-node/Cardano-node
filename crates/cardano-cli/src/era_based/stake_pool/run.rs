...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/StakePool/Run.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.StakePool.Run` types; the Rust port lands
