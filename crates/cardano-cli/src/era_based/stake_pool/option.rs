...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/StakePool/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.StakePool.Option` types; the Rust port lands
