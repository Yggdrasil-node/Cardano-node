...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/StakePool/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.StakePool.Command` types; the Rust port lands
