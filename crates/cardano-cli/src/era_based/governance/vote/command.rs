...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Vote/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Vote.Command` types; the Rust port lands
