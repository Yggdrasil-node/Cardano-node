...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Vote/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Vote.Option` types; the Rust port lands
