...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Actions/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Actions.Option` types; the Rust port lands
