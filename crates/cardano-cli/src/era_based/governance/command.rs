...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Governance/Command.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Governance.Command` types; the Rust port lands
