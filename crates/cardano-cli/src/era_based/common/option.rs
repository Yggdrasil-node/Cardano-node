...
//! ## Naming parity
//!
//! **Strict mirror:** `cardano-cli/cardano-cli/src/Cardano/CLI/EraBased/Common/Option.hs`.
...
///
/// Mirrors upstream `Cardano.CLI.EraBased.Common.Option` types; the Rust port lands
