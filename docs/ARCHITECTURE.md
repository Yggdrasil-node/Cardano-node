...
Upstream parity testing is complete with CBOR golden round-trip tests and cross-subsystem integration tests. Wire-format field names align with official Cardano CDDL schemas. `cargo test-all -- --list` currently discovers 4137 tests across all crates.
