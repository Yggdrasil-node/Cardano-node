...
**Status**: 182 parity rounds completed; production-ready across all subsystems with full `cardano-cli 10.16` query parity at preprod (Shelley) + preview (Alonzo) and Conway governance LSQ working end-to-end against `YGG_LSQ_ERA_FLOOR=6`
