...
**Status**: 184 parity rounds completed; production-ready across all subsystems with full `cardano-cli 10.16` query parity at preprod (Shelley) + preview (Alonzo) and Conway governance LSQ working end-to-end against `YGG_LSQ_ERA_FLOOR=6`
...
| **Total (R1–R184)** | **All subsystems** | **~900** | **all production-ready; 4 740 workspace tests passing, 0 failing** |
