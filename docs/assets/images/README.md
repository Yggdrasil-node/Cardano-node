...
| --- | --- | --- |
| `yggdrasil-banner.png` | Wide hero banner with the "YggdrasilNode — A Cardano Node Project Written In Rust" title | Top of [docs/index.md](../../index.md) and [README.md](../../../README.md) |
| `yggdrasil-logo.png` | Square tree-of-life mark, no text | just-the-docs sidebar `logo:`, used by `gh_edit_link` and `aux_links` icon |
| `favicon.png` | 32×32 PNG (or 64×64 retina) cropped from `yggdrasil-logo.png` | `<link rel="icon">` injected by `_includes/head_custom.html` |
...
```
docs/assets/images/yggdrasil-banner.png   # ~1428×590 wide hero, transparent or dark background
docs/assets/images/yggdrasil-logo.png     # ~512×512 square, transparent background
