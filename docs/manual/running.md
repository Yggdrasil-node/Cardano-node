...
For an automated restart-resilience verification, see [`dev/scripts/restart_resilience.sh`](https://github.com/yggdrasil-node/Cardano-node/blob/main/dev/scripts/restart_resilience.sh) and runbook §4.
